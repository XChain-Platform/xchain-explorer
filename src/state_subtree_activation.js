 ...
 * the state sub-tree extension spec).
 *
...
// for every slot, and stays that way until it arms on 2026-08-17.
//
...
//     has NO follower: it is SYNC_EXCLUDE'd on the mirror-only sync client, so
