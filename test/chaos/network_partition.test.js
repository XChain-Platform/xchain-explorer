...
// ---------------------------------------------------------------------------
function registerPartitionRefusal() {
...
function registerPartitionRecovery() {
    describe('CE-NET-01: Full Network Partition', function () {
        this.timeout(60000);
...
function registerPacketSlicing() {
...
function registerPacketSlicingRecovery() {
    describe('CE-NET-03: Packet Slicing (Degraded Network)', function () {
        this.timeout(60000);
...
// ---------------------------------------------------------------------------
function registerBandwidthResponses() {
...
function registerBandwidthRecovery() {
    describe('CE-NET-04: Bandwidth Throttling', function () {
        this.timeout(120000);
...
registerPartitionRefusal();
registerPartitionRecovery();
registerHighLatency();
registerPacketSlicing();
registerPacketSlicingRecovery();
registerBandwidthResponses();
registerBandwidthRecovery();
