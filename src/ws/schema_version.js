 ...
 * stamped `schema_version` at the three send sinks (WebSocketServer.send,
 * Broadcaster's per-subscriber send in broadcastToChannelKey, and
 * Broadcaster.send), so subscribers can gate their parsing instead of
