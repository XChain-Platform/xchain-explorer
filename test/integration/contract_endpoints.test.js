...
async function setupContractEndpoints() {
    this.timeout(30000);
...
async function teardownContractEndpoints() {
...
function registerGetContractTests() {
...
function registerPostValidationTests() {
...
describe('Contract endpoints (integration)', function () {
    before(function () { return setupContractEndpoints.call(this); });
    after(function () { return teardownContractEndpoints.call(this); });
    ...
    describe('GET /RBTC/api/contract/{idx}', registerGetContractTests);

    describe('POST /RBTC/api/contract/{idx}/call', function () {
        registerPostValidationTests();
        registerVmTests();
    });
});
