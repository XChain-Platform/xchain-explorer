...
function makeValidatorSetServer() {
...
module.exports = { EMPTY_ROOT, buildStore, makeServer, CHAIN, NET, COIN, ADDR_A, ADDR_Z, TICK, BLOCK, blockRows, BLOCK_MERKLE, makeActionServer, S, CAP, PKA, PKB, PKC, VALS, makeValidatorSetServer };
