 ...
 **********************************************************************
 *
 * XChain Explorer - the execution feed and its rollups
 *
 * One part of src/db/readers/contracts.js (the entry composes it through
 * composeReaderParts). The paged execution feed, one execution, and the
 * emission, deposit and withdrawal rollups that hang off executions.
 *
 * The three rollups stay beside the executions they summarise: each one is
 * the same feed filtered to one effect, and a change to how an execution
 * is joined has to reach all four in the same edit.
 *
...
class ContractExecutionReaders {
...
module.exports = ContractExecutionReaders.prototype;
