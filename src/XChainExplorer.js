    ...
    setupUrls(){
        ...
        let urls = {
            ...
            'api' : {
                ...
                '/{COIN}/api/messages/{QUERY}'      : ['getMessages',     ['block', 'address', 'source', 'destination']],
                '/{COIN}/api/mints/{QUERY}'         : ['getMints',        ['block', 'address', 'source', 'destination', 'token']],
                '/{COIN}/api/orders/{QUERY}'        : ['getOrders',       ['block', 'address', 'token']],
                '/{COIN}/api/order_matches/{QUERY}' : ['getOrderMatches', ['block']],
                '/{COIN}/api/sends/{QUERY}'         : ['getSends',        ['block', 'address', 'source', 'destination', 'token']],
                '/{COIN}/api/sleeps/{QUERY}'        : ['getSleeps',       ['block', 'address', 'token']],
                '/{COIN}/api/swaps/{QUERY}'         : ['getSwaps',        ['block', 'address', 'token']],
                '/{COIN}/api/swap_matches/{QUERY}'  : ['getSwapMatches',  ['block']],
                '/{COIN}/api/sweeps/{QUERY}'        : ['getSweeps',       ['block', 'address', 'source', 'destination']],
                // Misc API Endpoints
