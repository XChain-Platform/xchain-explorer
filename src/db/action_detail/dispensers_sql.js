 ...
 *
 **********************************************************************
 * SQL text for the dispenser-family and COINPAY action-detail handlers in
 * src/action-detail/dispensers.js. Each constant is one whole statement, named
 * for the handler and the query slot it fills; action_detail_io runs it.
 ********************************************************************/

'use strict';

const COINPAY_QUERY = `SELECT
                    a2.action,
                    a1.action_format,
                    m.action_index,
...
const COINPAY_EXPIRE_QUERY = `SELECT
                    a2.action,
                    a1.action_format,
                    m.action_index,
                    m.obligation_action_index,
...
const DISPENSER_CANCEL_QUERY = `SELECT
                    a2.action,
                    a1.action_format,
                    m.action_index,
...
const DISPENSER_CLOSE_QUERY = `SELECT
                    a4.action,
                    m.action_index,
                    a1.action_format, 
                    m.dispenser_action_index,
...
const DISPENSER_EDIT_QUERY = `SELECT
                    a2.action,
                    a1.action_format,
                    m.action_index,
                    m.dispenser_action_index,
...
const DISPENSER_EXPIRE_QUERY = `SELECT
                    a4.action,
                    m.action_index,
                    a1.action_format, 
                    m.dispenser_action_index,
