 ...
 *
 **********************************************************************
 * SQL text for the token-supply and transfer action-detail handlers in
 * src/action-detail/tokens.js. Each constant is one whole statement, named for
 * the handler and the query slot it fills; action_detail_io runs it.
 ********************************************************************/

'use strict';

const AIRDROP_QUERY = `SELECT
                    a3.action,
                    a2.action_format,
                    a1.action_index,
