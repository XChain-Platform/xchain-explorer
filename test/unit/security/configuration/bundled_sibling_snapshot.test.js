...
function registerBundledSiblingSnapshotTests() {
    ...
    bundledSiblings().forEach(registerSiblingSnapshotTests);
}

function registerSiblingSnapshotTests(sibling) {
...
describe('Security: bundled sibling lockfile snapshots @regression @tier4', function () {
    registerBundledSiblingSnapshotTests();
});
