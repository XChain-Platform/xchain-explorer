...
// xchain-hub/src/hub-schema-version.js; a v1 indexer must reject the v2 stream
// until it has migrated (its own uq_cap_snap widened via the 2026-07-20 migration).
