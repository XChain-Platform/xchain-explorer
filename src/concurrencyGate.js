 ...
 **********************************************************************
 *
 * XChain Explorer - global in-flight concurrency gate
 *
 ...
 * link) stays under every per-IP bucket while pinning every DB connection and
 * event-loop slot, so the service degrades into timeouts for everybody
 * instead of refusing the excess. This gate counts requests actually in
