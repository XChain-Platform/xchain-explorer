...
// snapshot_block gate that decides whether quorum-class retraction broadcasts
// must carry a 2f+1 co-signature. The gate is fail-safe by design (below the
// threshold and on any unknown/garbage input it returns false, i.e. legacy
